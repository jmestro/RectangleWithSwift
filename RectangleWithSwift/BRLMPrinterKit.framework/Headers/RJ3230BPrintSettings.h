//
//  RJ3230BPrintSettings.h
//  BMSPrinterKit
//
//  Created by BMS on 8/5/21.
//  Copyright (c) 2012-21 Brother Mobile Solutions. All rights reserved.
//

#import <BRLMPrinterKit/GenericMobileLabelModelPrintSettings.h>


@interface RJ3230BPrintSettings : GenericMobileLabelModelPrintSettings <PrintSettingsDelegate>

// These definitions are provided for information only. DO NOT MODIFY!
// spec section 4.3.1 Resolution
#define RJ3230B_RESOLUTION_HORZ 203
#define RJ3230B_RESOLUTION_VERT 203
// spec section 4.3.6 Raster Line
#define RJ3230B_HEADSIZEDOTS 576
...
#define RJ3230B_MAX_COMPRESS_LENGTH 72

// NOT in spec. *** Used Windows Printer Driver as reference ***
// NOTE: MAXPAPERWIDTH DOES exceed HEADSIZEDOTS!!
#define RJ3230B_MIN_PAPERWIDTHDOTS (0.47F * RJ3230B_RESOLUTION_HORZ) // 95
#define RJ3230B_MAX_PAPERWIDTHDOTS (3.15F * RJ3230B_RESOLUTION_HORZ) // 639.
// spec section 4.3.4 Maximum and Minimum Lengths
#define RJ3230B_MIN_PAPERLENGTHDOTS 96
#define RJ3230B_MAX_PAPERLENGTHDOTS 7992
...
#define RJ3230B_MIN_MARGINLENGTHDOTS 24
...
#define RJ3230B_MIN_MARGINLENGTHDOTS 0
...
#define RJ3230B_MIN_PAGEFEEDDOTS_LASTPAGE 24

#endif

#define RJ3230B_MAX_MARGINLENGTHDOTS 1015
// Arbitrarily restrict extraFeed to 11" at 203 dpi. There is no reason to be larger.
#define RJ3230B_MAX_EXTRAFEEDDOTS (11*RJ3230B_RESOLUTION_VERT)

//*** IMPORTANT ***
// SDK Users:
// You should NEVER instantiate an object of the GenericMobileLabelModelPrintSettings class.
// Instead, you should instantiate one of the model-specific subclasses (i.e. RJ3230BPrintSettings).
//
