...
@interface RJ3250WBPrintSettings : GenericMobileLabelModelPrintSettings <PrintSettingsDelegate>

// These definitions are provided for information only. DO NOT MODIFY!
// spec section 4.3.1 Resolution
#define RJ3250WB_RESOLUTION_HORZ 203
#define RJ3250WB_RESOLUTION_VERT 203
// spec section 4.3.6 Raster Line
#define RJ3250WB_HEADSIZEDOTS 576
...
#define RJ3250WB_MAX_COMPRESS_LENGTH 72

// NOT in spec. *** Used Windows Printer Driver as reference ***
// NOTE: MAXPAPERWIDTH DOES exceed HEADSIZEDOTS!!
#define RJ3250WB_MIN_PAPERWIDTHDOTS (0.47F * RJ3250WB_RESOLUTION_HORZ) // 95
...
#define RJ3250WB_MIN_MARGINLENGTHDOTS 24
...
#define RJ3250WB_MIN_MARGINLENGTHDOTS 0
...
#define RJ3250WB_MIN_PAGEFEEDDOTS_LASTPAGE 24

#endif

#define RJ3250WB_MAX_MARGINLENGTHDOTS 1015
// Arbitrarily restrict extraFeed to 11" at 203 dpi. There is no reason to be larger.
#define RJ3250WB_MAX_EXTRAFEEDDOTS (11*RJ3250WB_RESOLUTION_VERT)

//*** IMPORTANT ***
// SDK Users:
// You should NEVER instantiate an object of the GenericMobileLabelModelPrintSettings class.
// Instead, you should instantiate one of the model-specific subclasses (i.e. RJ3250WBPrintSettings).
//
